...
![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/20200312210355.png)
...
+ 有向图的强连通性
  ...
  + 尽可能大的双向连通节点子集
    ...
    ![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/20200312211637.png)
...
+ Andrei Broder等发现万维网包含一个超大强连通分量SCC，加上其他部分，显示出一种形象的结构
  ...
  + SCC![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/20200312212901.png)
...
+ 如何按照”领结“思路，获得一个有向图的几个组成部分？
  ...
  ![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/20200312213326.png)
...
+ 有向图的“领结”表示
  ...
  ![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/领结.png)
...
![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/20200312224422.png)
...
![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/20200312225302.png)

从上图去掉$(G, A)$和$(F, A)$ 边，添加 $(F, G)$ 和 ${G, A}$ 两条边，得到：

![](https://cdn.jsdelivr.net/gh/fred1653/Image-Hosting/img/20200312225401.png)
